...
* [devops\_roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,659 | 🐛 18 | 🌐 TypeScript | 📅 2026-08-21

## Build And Release System

The system for software build and release, continuous integration and continuous delivery

* [Luigi](https://github.com/spotify/luigi) ⭐ 18,766 | 🐛 170 | 🌐 Python | 📅 2026-07-18 Luigi is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 316,442 | 🐛 15 | 🌐 Python | 📅 2026-08-25
...
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,724 | 🐛 19 | 📅 2026-08-19\
