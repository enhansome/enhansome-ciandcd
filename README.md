...
* [devops\_roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 367,375 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-16

## Build And Release System

The system for software build and release, continuous integration and continuous delivery

* [Luigi](https://github.com/spotify/luigi) ⭐ 18,774 | 🐛 176 | 🌐 Python | 📅 2026-07-18 Luigi is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 320,961 | 🐛 19 | 🌐 Python | 📅 2026-09-15
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,554 | 🐛 106 | 📅 2026-09-02
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,831 | 🐛 32 | 📅 2026-09-12\
