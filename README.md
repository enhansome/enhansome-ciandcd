...
* [devops\_roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 367,485 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17

## Build And Release System

The system for software build and release, continuous integration and continuous delivery

* [Luigi](https://github.com/spotify/luigi) ⭐ 18,775 | 🐛 178 | 🌐 Python | 📅 2026-07-18 Luigi is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 321,211 | 🐛 20 | 🌐 Python | 📅 2026-09-15
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,946 | 🐛 106 | 📅 2026-09-02
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,840 | 🐛 32 | 📅 2026-09-12\
...
* [ci tools compare 3](https://github.com/ligurio/Continuous-Integration-services) ⭐ 4,147 | 🐛 21 | 📅 2026-08-27
