...
* [devops\_roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 365,415 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-21

## Build And Release System

The system for software build and release, continuous integration and continuous delivery

* [Luigi](https://github.com/spotify/luigi) ⭐ 18,765 | 🐛 170 | 🌐 Python | 📅 2026-07-18 Luigi is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
...
* [Macaca](https://github.com/alibaba/macaca) ⭐ 3,184 | 🐛 64 | 📅 2022-09-18 Automation test solution for native, hybrid, mobile web and web application on mobile and desktop platforms
...
* [fpm](https://github.com/jordansissel/fpm) ⭐ 11,501 | 🐛 790 | 🌐 Ruby | 📅 2026-08-20 Effing package management! Build packages for multiple platforms (deb, rpm, etc) with great ease and sanity.
...
* [murder](https://github.com/lg/murder) ⚠️ Archived  Large scale server deploys using BitTorrent and the BitTornado library from twitter.com
* [herd](https://github.com/russss/Herd) ⚠️ Archived A single-command bittorrent distribution system, based on Twitter's Murder
...
* [awesome-python](https://github.com/vinta/awesome-python) ⭐ 316,107 | 🐛 15 | 🌐 Python | 📅 2026-08-25
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 500,000 | 🐛 106 | 📅 2026-08-21
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,712 | 🐛 18 | 📅 2026-08-19\
...
* [ci tools compare 3](https://github.com/ligurio/Continuous-Integration-services) ⭐ 4,134 | 🐛 20 | 📅 2026-07-29
