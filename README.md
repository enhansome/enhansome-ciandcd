...
* [devops\_roadmap](https://github.com/kamranahmedse/developer-roadmap) ⭐ 367,258 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-14

## Build And Release System

The system for software build and release, continuous integration and continuous delivery

* [Luigi](https://github.com/spotify/luigi) ⭐ 18,775 | 🐛 175 | 🌐 Python | 📅 2026-07-18 Luigi is a Python module that helps you build complex pipelines of batch jobs. It handles dependency resolution, workflow management, visualization etc. It also comes with Hadoop support built in.
...
* [fpm](https://github.com/jordansissel/fpm) ⭐ 11,506 | 🐛 788 | 🌐 Ruby | 📅 2026-09-14 Effing package management! Build packages for multiple platforms (deb, rpm, etc) with great ease and sanity.
...
* [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,203 | 🐛 106 | 📅 2026-09-02
* [awesome-docker](https://github.com/veggiemonk/awesome-docker) ⭐ 36,826 | 🐛 32 | 📅 2026-09-12\
...
* [ci tools compare 3](https://github.com/ligurio/Continuous-Integration-services) ⭐ 4,146 | 🐛 21 | 📅 2026-08-27
